...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'meuticket'),  # Nome do banco de dados
        'USER': os.environ.get('DB_USER', 'meuticket_user'),  # Nome de usuário
        'PASSWORD': os.environ.get('DB_PASSWORD', 'bPkgxMlmYUjYw2mTFjofNgpIlev1ZHdN'),  # Senha
        'HOST': os.environ.get('DB_HOST', 'dpg-ctpmsqi3esus73djalsg-a.oregon-postgres.render.com'),  # Host
        'PORT': os.environ.get('DB_PORT', '5432'),  # Porta
    }
}
